...
<head>
    ...
    <title>{{ isset($title) ? $title . ' - ' : '' }}Admin Dashboard - Lish AI Labs</title>
    ...
    <div class="flex h-screen relative z-10">
        ...
        <aside class="w-64 glass flex flex-col h-full fixed left-0 top-0">
            ...
            <div class="p-6 border-b border-white/10">
                <a href="{{ route('dashboard.admin') }}" class="flex items-center gap-3 text-decoration-none">
                    ...
                    <div>
                        <div class="font-bold text-lg bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Lish AI Labs</div>
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('dashboard.admin') }}" class="sidebar-link {{ request()->is('dashboard/admin') ? 'active' : '' }}">
