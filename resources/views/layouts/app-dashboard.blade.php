                ...
                @php
                    ...
                    if (auth()->user()->role === 'admin') {
                        $navItems = [
                            ...
                            ['section' => 'Management'],
                            ['icon' => 'ti-users', 'label' => 'Users', 'route' => '#'],
                            ['icon' => 'ti-calendar', 'label' => 'Attendance', 'route' => '#'],
                            ['icon' => 'ti-chart-bar', 'label' => 'Reports', 'route' => '#'],
                            ['section' => 'Settings'],
                        ...
                        $navItems = [
                            ...
                            ['section' => 'Attendance'],
                            ['icon' => 'ti-calendar', 'label' => 'My Attendance', 'route' => '#'],
                            ['icon' => 'ti-history', 'label' => 'History', 'route' => '#'],
                            ['section' => 'Settings'],
