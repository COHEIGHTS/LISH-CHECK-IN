...
<head>
    ...
    <title>{{ isset($title) ? $title . ' - ' : '' }}Attachee Dashboard - Lish AI Labs</title>
    ...
    <div class="flex h-screen relative z-10">
        ...
        <aside class="w-64 glass flex flex-col h-full fixed left-0 top-0">
            ...
            <div class="p-6 border-b border-white/10">
                <a href="{{ route('dashboard.attachee') }}" class="flex items-center gap-3 text-decoration-none">
                    ...
                    <div>
                        <div class="font-bold text-lg bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Lish AI Labs</div>
                        <div class="text-xs text-white/50">Attachee Panel</div>
                    </div>
                </a>
            </div>
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('dashboard.attachee') }}" class="sidebar-link {{ request()->is('dashboard/attachee') ? 'active' : '' }}">
